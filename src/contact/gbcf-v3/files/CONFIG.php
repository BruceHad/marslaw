...
##################################################################
    ...
    $send_email    = "you@yourdomain.com";       // Your email

    $reply_email   = "noreply@yourdomain.com";   // Reply email
...
##################################################################
    ...
    $addressee     = "Webmaster";   // Your name/Company name

    $web_site      = "Website";     // Your site or company name
